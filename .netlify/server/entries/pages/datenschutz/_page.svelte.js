...
import { s as setClient, q as query, m as myclient, G as GET_CONTENT_PRIVACY } from "../../../chunks/queries.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-4jt55z_START -->${$$result.title = `<title>Hahnheim eSports - Retro LAN Party - DATENSCHUTZ</title>`, ""}<!-- HEAD_svelte-4jt55z_END -->`, ""}
